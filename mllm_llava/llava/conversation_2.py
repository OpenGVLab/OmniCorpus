...
class Conversation:
    ...
    def get_prompt(self) -> str:
        ...
        elif self.sep_style == SeparatorStyle.HUSKY_N:   # 添加了\n的template
            seps = [self.sep, self.sep2]
        ...
        elif self.sep_style == SeparatorStyle.INTERNLM2_CHAT:  # internlm2 chat template
            ## <|im_start|>user\n{record[0]}<|im_end|>\n<|im_start|>assistant\n{record[1]}<|im_end|>\n
            seps = [self.sep, self.sep2]
...
# HUSKY2 template： roles使用special token
register_conv_template(
    Conversation(
        name="husky_v2.0",
        system_template="",
...
register_conv_template(
    Conversation(
        ...
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.HUSKY_N,
        sep=" ",
        sep2="</s>",
    )
)
...
register_conv_template(
    Conversation(
        ...
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.INTERNLM2_CHAT,
        sep="<|im_end|>\n",
        sep2="<|im_end|>\n",
    )
)
