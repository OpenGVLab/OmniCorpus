...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_interleaved_v3(
        ...
        # TODO: 优化图像加载，现在图像这边是有pad的图，会有不高效的问题
        ...
        # # <<<< check num_img with is_monochrome <<<<
        max_num_images = getattr(self.config, 'max_num_images', 6)
        ...
        image_features = torch.split(image_features, split_size, dim=0)  # List[Tk F v d]
