...
def main():
    ...
    total_steps = (args.train_num_samples_interleaved) // (args.batch_size_interleaved * args.world_size * args.workers)
    args.train_num_samples_interleaved = total_steps * args.batch_size_interleaved * args.world_size * args.workers
    args.train_num_samples_laion = total_steps * args.batch_size_laion * args.world_size * args.workers
    print(f"train_num_samples_interleaved: {args.train_num_samples_interleaved}")
    print(f"train_num_samples_laion: {args.train_num_samples_laion}")
